...
/**
 * Porta de saída para operações de autenticação. Esta interface define o contrato para autenticar
 * usuários e obter tokens de acesso. Implementações desta interface podem se comunicar com serviços
 * de autenticação externos, nesse caso o Keycloak, para validar as credenciais do usuário e
 * retornar os tokens apropriados.
 */
public interface AuthPort {
   ...
   * @return Uma TokenResponse contendo o token de acesso, token de atualização, tempo de expiração
   *     e tipo de token.
   * @throws AuthenticationException Se a autenticação falhar devido a credenciais inválidas ou
   *     outros problemas.
   */
   ...
   * @return Uma TokenResponse contendo o novo token de acesso, token de atualização, tempo de
   *     expiração e tipo de token.
   * @throws AuthenticationException Se a atualização do token falhar devido a um token de
   *     atualização inválido ou outros problemas.
   */
   ...
   * @throws AuthenticationException Se o logout falhar devido a um token de atualização inválido ou
   *     outros problemas.
   */
